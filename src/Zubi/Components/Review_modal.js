...
import { StyleSheet, Text, View, TouchableOpacity,Dimensions,SafeAreaView ,FlatList, ScrollView,Image,TextInput} from 'react-native';
    ...
    <View style={styles.modalView} >
        <View style={{
            ...
            <LinearGradient
                ...
                style={styles.cross}
            >
                <TouchableOpacity onPress={()=>set_modal(!modal)} >
        ...
        <ScrollView contentContainerStyle={{paddingBottom:20}}>
            ...
            <View style={{width:'95%',alignSelf:'center'}} >
                ...
                <LinearGradient
                    ...
                    style={styles.btn}
                >
                    <TouchableOpacity onPress={btn_click} style={styles.inside} >
